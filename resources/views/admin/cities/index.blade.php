    ...
    <div class="content-wrapper">
        <div class="row mb-4">
            <div class="col-12 col-md-4">
                <h3 style="margin-top: 5px;">Все города</h3>
            </div>
            <div class="col-12 col-md-8">
                <div class="d-flex align-items-sm-center flex-column flex-sm-row justify-content-sm-end">
                    <div class="ml-sm-4">
                        <a href="{{ route('admin.city.create') }}" class="btn btn-lg btn-primary">Создать город</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover center-aligned-table">
                                ...
                                <tr>
                                    ...
                                    <td><a class="text-dark font-weight-bold" href="{{ route('admin.city.edit', $item->id) }}">{{ $item->title }}</a></td>
                                    <td>{{ $item->created_at }}</td>
                                    <td>
                                        <div class="d-flex justify-content-end gap-1">
                                        <a href="{{ route('admin.city.edit', $item->id) }}" title="Редактировать" class="btn btn-primary btn-sm">
                                            Редактировать
                                        </a>
